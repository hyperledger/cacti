...
export abstract class BridgeManager {
   ...
   **/
  public abstract lockAsset(assetId: string): Promise<string>;
  /**
   * Unlocks an asset on the blockchain
   * @param assetId
   * @returns transaction hash
   **/
  public abstract unlockAsset(assetId: string): Promise<string>;
  /**
   * Mints an asset on the blockchain
   * @param assetId
   * @returns transaction hash
   **/
  public abstract mintAsset(assetId: string): Promise<string>;
  /**
   * Burns an asset on the blockchain
   * @param assetId
   * @returns transaction hash
   **/
  public abstract burnAsset(assetId: string): Promise<string>;
  /**
