...
contract SATPWrapTest {
    ...
    function checkWrap() public {
        wrapperContract.wrap(address(contract1), TokenType.ERC20, contract1.getId(), address(this));
    ...
    function checkWrapTokenAlreadyWrapped() public {
        ...
        try wrapperContract.wrap(address(contract1), TokenType.ERC20, contract1.getId(), address(this)) returns (bool s) {
    ...
    function checkLock() public {
        ...
        wrapperContract.wrap(address(contract2), TokenType.ERC20, contract2.getId(), address(this));
