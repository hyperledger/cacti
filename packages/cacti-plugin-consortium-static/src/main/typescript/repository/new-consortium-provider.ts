...
import {
  DefaultApi as ConsortiumNewApi,
  GetConsortiumJwsResponse,
} from "../generated/openapi/typescript-axios/api";

export interface INewConsortiumProviderOptions {
  logLevel?: LogLevelDesc;
  apiClient: ConsortiumNewApi;
}

export class NewConsortiumProvider
  implements IAsyncProvider<ConsortiumDatabase>
{
  public static readonly CLASS_NAME = "NewConsortiumProvider";

  private readonly log: Logger;

  public get className(): string {
    return NewConsortiumProvider.CLASS_NAME;
  }

  constructor(public readonly options: INewConsortiumProviderOptions) {
  ...
  parseConsortiumJws(response: GetConsortiumJwsResponse): ConsortiumDatabase {
    const fnTag = `NewConsortiumProvider#parseConsortiumJws()`;
