...
export interface INewConsortiumRepositoryOptions {
 ...
 */
export class NewConsortiumRepository {
  public static readonly CLASS_NAME = "NewConsortiumRepository";
  ...
  public get className(): string {
    return NewConsortiumRepository.CLASS_NAME;
  }

  constructor(public readonly options: INewConsortiumRepositoryOptions) {
